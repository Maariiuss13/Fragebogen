...
<div>
    ...
    if (isset($_GET["error"])) {
        if ($_GET["error"] == "AnzahlFragenKleinerGleichNull") {
            echo '<p align="center" style="color: red;">Geben Sie bitte eine Anzahl an Fragen an</p>';
        }
        if ($_GET["error"] == "leerefelder") {
            echo '<p align="center" style="color: red;">Bitte füllen Sie alle Felder aus</p>';
        }
